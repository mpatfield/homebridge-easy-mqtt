const vi = {
  ...
  accessory: {
    ...
    statusActive: '%s đang hoạt động',
    statusInactive: '%s hiện không hoạt động',
    unavailable: '%s không khả dụng',
  },
  ...
  autoReset: {
    ...
    teardown: '%s đang chờ được đặt lại. Tiến hành đặt lại ngay bây giờ.',
  },
  ...
  config: {
    ...
    title: {
      ...
      maximumDuration: 'Thời gian tối đa (phút)',
      minimum: 'Tối thiểu',
      minimumDuration: 'Thời gian tối thiểu (phút)',
      minimumStep: 'Bước điều chỉnh',
      name: 'Tên',
      options: 'Tùy chọn',
      password: 'Mật khẩu',
      protocol: 'Giao thức',
      resetOnRestart: 'Đặt lại khi khởi động',
      simulateDuration: 'Thời gian mô phỏng',
      ...
      topicGetAvailable: 'Topic lấy trạng thái khả dụng',
      ...
      topicGetStatusActive: 'Topic lấy trạng thái hoạt động',
      ...
      valueStatusActive: 'Giá trị trạng thái hoạt động',
  ...
  startup: {
    ...
    matterNewAccessory: 'Đang thêm phụ kiện Matter mới:',
    matterRemoveAccessory: 'Đang xóa phụ kiện Matter:',
    matterRestoringAccessory: 'Đang khôi phục phụ kiện Matter:',
  ...
  valve: {
    ...
    durationTopicsIgnored: '%s đang sử dụng bộ hẹn giờ tích hợp, vì vậy các topic thời lượng %s sẽ bị bỏ qua',
