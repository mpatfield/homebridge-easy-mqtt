const fr = {
  ...
  accessory: {
    ...
    statusActive: '%s est actif',
    statusInactive: '%s est inactif',
  ...
  autoReset: {
    ...
    teardown: '%s attend actuellement d\'être réinitialisé. Réinitialisation en cours.',
  },
  ...
  config: {
    ...
    title: {
      ...
      maximum: 'Maximum',
      maximumDuration: 'Durée Maximale (en minutes)',
      minimum: 'Minimum',
      minimumDuration: 'Durée Minimale (en minutes)',
      minimumStep: 'Pas',
      name: 'Nom',
      options: 'Options',
      ...
      simulateDuration: 'Simuler la Durée',
      ...
      topicGetAvailable: 'Obtenir Disponible/Atteignable',
      ...
      topicGetStatusActive: 'Obtenir le Statut Actif',
      ...
      valueStatusActive: 'Statut Actif',
  ...
  startup: {
    ...
    matterDisabled: 'Matter est actuellement désactivé. Veuillez activer Matter dans le pont parent %s.',
    matterGroups: 'Les groupes ne sont pas encore pris en charge pour les accessoires Matter',
    matterNewAccessory: 'Ajout d\'un nouvel accessoire Matter :',
    matterRemoveAccessory: 'Suppression de l\'accessoire Matter :',
    matterRestoringAccessory: 'Restauration de l\'accessoire Matter :',
    matterUnavailable: 'Matter n\'est pas disponible avec cette version de Homebridge. Passez à Homebridge v2.0+ pour utiliser Matter avec %s.',
    unsupportedProtocol: 'Protocole %s non pris en charge. Doit être l\'un des suivants : %s',
  ...
  valve: {
    ...
    durationTopicsIgnored: '%s utilise une minuterie intégrée, donc les sujets de durée %s seront ignorés',
