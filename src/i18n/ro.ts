const ro = {
  ...
  accessory: {
    ...
    statusActive: '%s este activ',
    statusInactive: '%s este inactiv',
    unavailable: '%s nu este disponibil',
  },
  ...
  autoReset: {
    ...
    teardown: '%s așteaptă în prezent să fie resetat. Se efectuează resetarea acum.',
  },
  ...
  config: {
    ...
    title: {
      ...
      maximum: 'Maxim',
      maximumDuration: 'Durată maximă (minute)',
      minimum: 'Minim',
      minimumDuration: 'Durată minimă (minute)',
      minimumStep: 'Pas',
      name: 'Nume',
      options: 'Opțiuni',
      password: 'Parolă',
      ...
      simulateDuration: 'Simulează durata',
      ...
      topicGetAvailable: 'Obține disponibil/accesibil',
      ...
      topicGetStatusActive: 'Obține starea activă',
      ...
      valueStatusActive: 'Stare activă',
  ...
  startup: {
    ...
    matterDisabled: 'Matter este momentan dezactivat. Te rugăm să activezi Matter în bridge-ul părinte %s.',
    matterGroups: 'Grupurile nu sunt încă acceptate pentru accesoriile Matter',
    matterNewAccessory: 'Se adaugă un nou accesoriu Matter:',
    matterRemoveAccessory: 'Se elimină accesoriul Matter:',
    matterRestoringAccessory: 'Se restaurează accesoriul Matter:',
    matterUnavailable: 'Matter nu este disponibil cu această versiune de Homebridge. Te rugăm să actualizezi la Homebridge v2.0+ pentru a folosi Matter cu %s.',
    unsupportedProtocol: 'Protocol neacceptat %s. Trebuie să fie unul dintre: %s',
  ...
  valve: {
    ...
    durationTopicsIgnored: '%s folosește un cronometru integrat, așa că topicurile de durată %s vor fi ignorate',
    inUse: '%s este în uz',
