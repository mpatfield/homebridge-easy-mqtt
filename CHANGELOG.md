...
### Added
- [Minimum/maximum temperature](https://github.com/mpatfield/homebridge-easy-mqtt/wiki/Thermostat) for `Thermostat` ([#221](https://github.com/mpatfield/homebridge-easy-mqtt/issues/221))
